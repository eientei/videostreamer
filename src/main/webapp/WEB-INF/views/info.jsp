...
<div class="fancybox">
    ...
    <ul>
        ...
        <li>
            Broadcast Settings -> FMS URL: ${rtmpBase}/live
        </li>
        <li>
            Broadcast Settings -> Play Path/Stream key: 128c853bb99bfeb971f9f766c92326c8 (the key you have in your <a href="${pageContext.request.contextPath}/profile">profile</a>, 128c853bb99bfeb971f9f766c92326c8 is just an example how it may look like)
        </li>
        <li>
    ...
    <p>
        This will run ffmpeg grabbing display of size 1366x768 with reasonable defaults for live streaming. ${rtmpBase}/live/128c853bb99bfeb971f9f766c92326c8 is your rtmp publish url as seen in your profile.
    </p>
    <p>
        To add some sond to your stream, try following (if you're using pulseaudio)
    </p>
    <div class="code">
        ffmpeg -r 30 -f x11grab -s 1366x768 -i :0.0 -f pulse -ac 2 -i loopback.monitor -vcodec libx264 -preset ultrafast -tune zerolatency -pix_fmt yuv420p -s 1366x768 -ar 44100 -threads 0 -f flv ${rtmpBase}/live/128c853bb99bfeb971f9f766c92326c8
    </div>
    <p>
        the part
    </p>
    <div class="code">
        -f pulse -ac 2 -i sinkname.monitor
    </div>
    <p>
        should capture your sink output 'sinkname', which can be found by executing
    </p>
    <div class="code">
        pacmd list-sinks
    </div>
