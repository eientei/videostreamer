...
import org.eientei.video.backend.orm.dao.StreamDAO;
...
public class StreamService {
    ...
    public synchronized Stream allocateStream(User user) throws TooManyStreams {
        ...
        while (getStream("live", name) != null || otherStreamExists(user, name)) {
    ...
    private boolean otherStreamExists(User user, String name) {
        User other = userService.getUserByUserName(name);
