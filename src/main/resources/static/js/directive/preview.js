...
angular.module('videostreamer').directive('preview', ['$templateCache', '$document', '$compile', '$animate', '$position', '$q', function ($templateCache, $document, $compile, $animate, $position, $q) {
    return {
        restrict: 'A',
